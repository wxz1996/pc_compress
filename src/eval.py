...
if __name__ == '__main__':
    ...
    parser.add_argument(
        ...
        default='/home/wenxuanzheng/pc_compression/pcc_geo_cnn-master/patch_ply/part_ply/2048')
    parser.add_argument(
        '--ori_pattern',
    ...
    parser.add_argument(
        ...
        default='/home/wenxuanzheng/pc_compression/mix_compression/output/00005/2048/rec_pc')
    parser.add_argument(
        '--pc_error_path',
        help='Path to pc_error executable.',
        default='/home/wenxuanzheng/pc_compression/geo_dist-master/build/pc_error')
    parser.add_argument(
        '--decompressed_suffix',
    ...
    parser.add_argument(
        ...
        default='/home/wenxuanzheng/pc_compression/mix_compression/output/00005/2048/bin')
    parser.add_argument(
        '--compressed_suffix',
    ...
    parser.add_argument(
        ...
        default='/home/wenxuanzheng/pc_compression/mix_compression/output/00005/2048-eval.csv')
    parser.add_argument(
        '--pc_error_knn',
        type=int,
