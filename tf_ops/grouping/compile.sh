...
g++ -std=c++11 tf_nndistance.cpp tf_nndistance.cu.o -o tf_nndistance.so -shared -fPIC -I $TF_LIB/include -I /usr/local/cuda/include -I $TF_LIB/include/external/nsync/public -lcudart -L /usr/local/cuda/lib64/ -L$TF_LIB -ltensorflow_framework -O2 -D_GLIBCXX_USE_CXX11_ABI=1
